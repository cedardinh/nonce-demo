...
public class NonceComponent {
    ...
    public NonceExecutionResult withNonce(String signer, NonceExecutionHandler handler) {
        return executionTemplate.execute(signer, handler);
    }
